...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)//数据库类型
                ...
                .setUrl("jdbc:mysql://venn8888.cn:3333/yy-skate")
                .setUsername("root")
                .setPassword("123456");
        //3、策略配置
        ...
        strategyConfig.setCapitalMode(true)//开启全局大写命名
                ...
                .setInclude("so_charge_category","so_charge_doc","so_charge_type");//逆向工程使用的表
        //4、包名策略配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("com.yy.order")//设置包名的parent
                .setMapper("mapper")
                .setService("service")
